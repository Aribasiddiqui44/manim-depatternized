...
class Scene(object):
    ...
    def on_mouse_drag(self, point: Vect3, d_point: Vect3, buttons: int, modifiers: int
        ) -> None:
        self.mouse_drag_point.move_to(point)
        if self.drag_to_pan:
            self.frame.shift(-d_point)
        # Directly handle the event without dispatching it

    def on_mouse_press(self, point: Vect3, button: int, mods: int
        ) -> None:
        self.mouse_drag_point.move_to(point)
        # Directly handle the event without dispatching it

    def on_mouse_release(self, point: Vect3, button: int, mods: int
        ) -> None:
        pass

    def on_mouse_scroll(self, point: Vect3, offset: Vect3, x_pixel_offset: float, y_pixel_offset: float) -> None:
    ...
    def on_key_release(self, symbol: int, modifiers: int) -> None: pass
